// ISO 3166-1 alpha-2 list. `name` is what the guest sees / picks from the datalist;
// `iso` is what gets stored alongside it (and what the police site expects in its own ISO column).
window.COUNTRIES = [
  ...
  { name: "Brazil", iso: "BR" },
  { name: "British Indian Ocean Territory (the)", iso: "IO" },
  ...
  { name: "Canada", iso: "CA" },
  { name: "Cayman Islands (the)", iso: "KY" },
  { name: "Central African Republic (the)", iso: "CF" },
  { name: "Chad", iso: "TD" },
  { name: "Chile", iso: "CL" },
  { name: "China", iso: "CN" },
  { name: "Christmas Island", iso: "CX" },
  { name: "Cocos (Keeling) Islands (the)", iso: "CC" },
  { name: "Colombia", iso: "CO" },
  { name: "Comoros (the)", iso: "KM" },
  { name: "Congo (the Democratic Republic of the)", iso: "CD" },
  { name: "Congo (the)", iso: "CG" },
  { name: "Cook Islands (the)", iso: "CK" },
  ...
  { name: "Dominican Republic (the)", iso: "DO" },
  { name: "Ecuador", iso: "EC" },
  { name: "Egypt", iso: "EG" },
  ...
  { name: "Falkland Islands (the) [Malvinas]", iso: "FK" },
  { name: "Faroe Islands (the)", iso: "FO" },
  { name: "Fiji", iso: "FJ" },
  { name: "Finland", iso: "FI" },
  { name: "France", iso: "FR" },
  { name: "French Guiana", iso: "GF" },
  { name: "French Polynesia", iso: "PF" },
  { name: "French Southern Territories (the)", iso: "TF" },
  { name: "Gabon", iso: "GA" },
  ...
  { name: "Korea (the Democratic People's Republic of)", iso: "KP" },
  { name: "Korea (the Republic of)", iso: "KR" },
  { name: "Kuwait", iso: "KW" },
  { name: "Kyrgyzstan", iso: "KG" },
  { name: "Lao People's Democratic Republic (the)", iso: "LA" },
  { name: "Latvia", iso: "LV" },
  { name: "Lebanon", iso: "LB" },
  { name: "Lesotho", iso: "LS" },
  { name: "Liberia", iso: "LR" },
  ...
  { name: "Mali", iso: "ML" },
  { name: "Malta", iso: "MT" },
  { name: "Marshall Islands (the)", iso: "MH" },
  ...
  { name: "Moldova (the Republic of)", iso: "MD" },
  { name: "Monaco", iso: "MC" },
  ...
  { name: "Romania", iso: "RO" },
  { name: "Russian Federation (the)", iso: "RU" },
  { name: "Rwanda", iso: "RW" },
  { name: "Réunion", iso: "RE" },
  ...
  { name: "Turks and Caicos Islands (the)", iso: "TC" },
  { name: "Tuvalu", iso: "TV" },
  { name: "Uganda", iso: "UG" },
  { name: "Ukraine", iso: "UA" },
  { name: "United Arab Emirates (the)", iso: "AE" },
  { name: "United Kingdom of Great Britain and Northern Ireland (the)", iso: "GB" },
  { name: "United States Minor Outlying Islands (the)", iso: "UM" },
  { name: "United States of America (the)", iso: "US" },
  { name: "Uruguay", iso: "UY" },
